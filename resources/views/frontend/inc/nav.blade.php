...
.btn-outline-darker {
    ...
    @if (get_setting('topbar_banner') != null)
        <div class="position-relative top-banner removable-session z-1035 d-none" data-key="top-banner"
            data-value="removed" style="background-color: #216196;">
    ...
    <!-- Top Bar -->
    <div class="top-navbar z-1035 h-45px h-sm-auto" style="background-color: #216196;">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 text-left d-none d-lg-block">
                    <ul class="list-inline mb-0 h-100 d-flex justify-content-start align-items-center">
                        ...
                        @if (get_setting('helpline_number'))
                            ...
                            <li class="list-inline-item ml-3 pl-3 mr-0 pr-0">
                                <a href="tel:{{ get_setting('helpline_number') }}"
                                    class="text-white fs-15 d-inline-block py-2">
                                    <span>Call Us : </span>
                        ...
                        @endif
                            ...
                            <li class="list-inline-item ml-3 pl-3 mr-0 pr-0">
                                <a href="tel:{{ get_setting('helpline_number') }}"
                                    class="text-white fs-15 d-inline-block py-2">
                                    <span>Mail Us : </span>
                                    <span>info@iresindia.dental</span>
                                </a>
                            </li>
				 ...
				 <div class="col-lg-5 text-left d-none d-lg-block">
				 <div class="mb-0 h-100 d-flex justify-content-start align-items-center">
                   <p style="text-align: left;font-size: 17px;font-weight: 600;color: #fff;margin: 0px;line-height: 40px;">World Best&nbsp;Swiss&nbsp;Quality</p>
                </div>
				</div>
                
                <div class="col-lg-2 col">
                    <ul class="list-inline d-flex justify-content-between justify-content-end mb-0">
                        <!-- Language switcher -->
                        @if (get_setting('show_language_switcher') == 'on')
                            <li class="list-inline-item dropdown" id="lang-change">
                                ...
                                @endphp
                                <a href="javascript:void(0)" class="dropdown-toggle text-white fs-15 py-2"
                        ...
                        @else
                            ...
                            <span class="d-none d-xl-flex align-items-center nav-user-info ml-3">
                                ...
                                <a href="{{ route('user.login') }}"
                                    class="text-reset  hov-opacity-100 hov-text-primary fs-15 d-inline-block border-right border-soft-light border-width-2 pr-2 ml-3">{{ translate('Login') }}</a>
                                <a href="{{ route('user.registration') }}"
                                    class="text-reset  hov-opacity-100 hov-text-primary fs-15 d-inline-block py-2 pl-2">{{ translate('Registration') }}</a>
                            </span>
                        @endauth
                    </div>
					
					<img src="https://seolipi.com/ires-india/assets/images/demos/demo-3/handshake.png" class="abhand" alt=" " width="" height="" style="height: 55px;margin-left: 20px;">
                </div>
            </div>
